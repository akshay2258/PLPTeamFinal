			...
			<table border="1" align="center" >
				<sf:form action="addProgramOffered.do" modelAttribute="poffered" method="post">
			  	<tr>
				  	...
				  	<td>
				   		...
				   		<sf:errors path="programName" name="error" type="text" class="error"></sf:errors>
				...
				<tr>
					...
					<td>
						...
						<sf:errors path="description" name="error" class="error"></sf:errors>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<sf:errors path="applicantEligiblity" name="error" class="error"></sf:errors>
					</td>
				</tr>
			    ...
			    <tr>
				    ...
				    <td> 
						...
						<sf:errors path="duration" type="text" name="error"  class="error"></sf:errors>
					</td>
				</tr>
				...
				<sf:errors path="degreeCertificate" type="text" name="error" class="error"></sf:errors>
				</td>
				</tr>
